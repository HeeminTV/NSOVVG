...
:render
:: 마스터 오디오 파일 (%1) [Master audio file (%1)]
rem set "masterAudio=%~1"
rem echo on

:: 채널 오디오 파일들을 처리 (%2부터 끝까지) [Processing channel audio files (%2 From beginning to end)]
set channelCount=0
set H1Count=0
set H2Count=0
set "channelInputs="
...
:: 최종 출력 레이아웃을 정의 (Define the final output layout)
if "!bgimage!"=="None" (
	set "bgcf1="
	set "bgcf2="
) else if "!bgimage:~0,1!"=="#" (
